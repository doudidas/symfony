 ...
 */
class Itemtype extends \AppBundle\Entity\Itemtype implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Itemtype' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Itemtype' . "\0" . 'manufacturer', '' . "\0" . 'AppBundle\\Entity\\Itemtype' . "\0" . 'model', '' . "\0" . 'AppBundle\\Entity\\Itemtype' . "\0" . 'description'];
        }
