...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hmh04B9T4y', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ut89yO+DL2', 0, 'Gr-CbXDOCh0Bo6MaGPf15Q', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N68nIkorVD', 0, 'Gr-CbXDOCh0Bo6MaGPf15Q', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QC5appj8U0', 0, 'Gr-CbXDOCh0Bo6MaGPf15Q', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'path' => ($this->targetDirs[3].'/app/sqlite.db'), 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_769c9cb865dbcf78a2555135a36ce1b397a1457c3191aebc2f76d11b80ddd873');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/seller/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/manager/');
        ...
        $n->add($m, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FOSUserBundle', 1 => 'AsseticBundle', 2 => 'FrameworkBundle', 3 => 'SecurityBundle', 4 => 'TwigBundle', 5 => 'MonologBundle', 6 => 'SwiftmailerBundle', 7 => 'DoctrineBundle', 8 => 'SensioFrameworkExtraBundle', 9 => 'AppBundle', 10 => 'DebugBundle', 11 => 'WebProfilerBundle', 12 => 'SensioDistributionBundle', 13 => 'SensioGeneratorBundle', 14 => 'DoctrineFixturesBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('584640060fe5a1b5c80b2b90b341656242727e16');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '584640060fe5a1b5c80b2b90b341656242727e16',
            'locale' => 'en',
            ...
            'kernel.secret' => '584640060fe5a1b5c80b2b90b341656242727e16',
